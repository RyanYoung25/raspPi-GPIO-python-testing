...
def main():
    ...
    red = Scale(master, from_=0, to=100, orient=HORIZONTAL)
    red.pack()
    green = Scale(master, from_=0, to=100, orient=HORIZONTAL)
    green.pack()
    blue = Scale(master, from_=0, to=100, orient=HORIZONTAL)
    blue.pack()
    thread.start()
    mainloop()
